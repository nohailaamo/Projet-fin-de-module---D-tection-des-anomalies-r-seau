...
st.set_page_config(page_title="Détection d'anomalies Réseau",page_icon="https://github.com/nohailaamo/Projet-fin-de-module---D-tection-des-anomalies-r-seau/blob/main/applogo.png", layout="wide")
